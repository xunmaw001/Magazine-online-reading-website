...
public class FaxingfangEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FaxingfangEntity() {

	}

	public FaxingfangEntity(T t) {
		try {
    ...
    public String toString() {
        return "Faxingfang{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", faxingfangName=" + faxingfangName +
            ", faxingfangPhoto=" + faxingfangPhoto +
            ", sexTypes=" + sexTypes +
            ", faxingfangPhone=" + faxingfangPhone +
            ", faxingfangEmail=" + faxingfangEmail +
            ", faxingfangDelete=" + faxingfangDelete +
