...
public class ZazhixinxiOrderView extends ZazhixinxiOrderEntity implements Serializable {
	...
	public ZazhixinxiOrderView() {

	}

	public ZazhixinxiOrderView(ZazhixinxiOrderEntity zazhixinxiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, zazhixinxiOrderEntity);
