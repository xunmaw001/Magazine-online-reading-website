...
public class ZazhixinxiCollectionView extends ZazhixinxiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String zazhixinxiCollectionValue;
	...
	public ZazhixinxiCollectionView() {

	}

	public ZazhixinxiCollectionView(ZazhixinxiCollectionEntity zazhixinxiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zazhixinxiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getZazhixinxiCollectionValue() {
				return zazhixinxiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setZazhixinxiCollectionValue(String zazhixinxiCollectionValue) {
				this.zazhixinxiCollectionValue = zazhixinxiCollectionValue;
			}
