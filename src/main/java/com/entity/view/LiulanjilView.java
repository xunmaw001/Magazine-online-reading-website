 ...
 */
@TableName("liulanjil")
public class LiulanjilView extends LiulanjilEntity implements Serializable {
	...
	public LiulanjilView() {

	}

	public LiulanjilView(LiulanjilEntity liulanjilEntity) {
		try {
			BeanUtils.copyProperties(this, liulanjilEntity);
