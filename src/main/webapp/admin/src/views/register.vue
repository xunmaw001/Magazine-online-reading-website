<template>
    <div style="backgroundImage: url('/zazhizaixianyuedu/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">杂志在线阅读网站注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="发行方姓名" class="input" v-if="tableName=='faxingfang'">
                            <el-input v-model="ruleForm.faxingfangName" autocomplete="off" placeholder="发行方姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='faxingfang'">
                            <el-input v-model="ruleForm.faxingfangPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='faxingfang'">
                            <el-input v-model="ruleForm.faxingfangEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.faxingfangName)&& 'faxingfang'==this.tableName){
                                this.$message.error('发行方姓名不能为空');
                                return
                            }
                             if('faxingfang' == this.tableName && this.ruleForm.faxingfangPhone&&(!this.$validate.isMobile(this.ruleForm.faxingfangPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('faxingfang' == this.tableName && this.ruleForm.faxingfangEmail&&(!this.$validate.isEmail(this.ruleForm.faxingfangEmail))){
