<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='faxingfang'"  label='发行方姓名' prop="faxingfangName">
               <el-input v-model="ruleForm.faxingfangName"  placeholder='发行方姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='faxingfang'" label='图片' prop="faxingfangPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='faxingfang'"  label='联系方式' prop="faxingfangPhone">
               <el-input v-model="ruleForm.faxingfangPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='faxingfang'"  label='邮箱' prop="faxingfangEmail">
               <el-input v-model="ruleForm.faxingfangEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.faxingfangName)&& 'faxingfang'==this.flag){
                             this.$message.error('发行方姓名不能为空');
                             return
                         }

                         if((!this.ruleForm.faxingfangPhoto)&& 'faxingfang'==this.flag){
                             this.$message.error('图片不能为空');
                             return
                         }

                         if((!this.ruleForm.faxingfangPhone)&& 'faxingfang'==this.flag){
                             this.$message.error('联系方式不能为空');
                             return
                         }

                             if( 'faxingfang' ==this.flag && this.ruleForm.faxingfangEmail&&(!isEmail(this.ruleForm.faxingfangEmail))){
