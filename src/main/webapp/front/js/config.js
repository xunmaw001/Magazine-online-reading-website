...
var centerMenu = [
    ...
    ,{
        name: '浏览记录',
        url: '../liulanjil/list.html'
    }
    ,{
        name: '杂志收藏',
        url: '../zazhixinxiCollection/list.html'
    }
    ,{
        name: '杂志订单',
        url: '../zazhixinxiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '杂志信息',
        url: './pages/zazhixinxi/list.html'
    },

]

var adminurl =  "http://localhost:8080/zazhizaixianyuedu/admin/dist/index.html#/login";
